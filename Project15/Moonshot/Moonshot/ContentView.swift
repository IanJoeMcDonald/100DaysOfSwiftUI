        ...
        NavigationView {
                ...
                NavigationLink(destination: MissionView(mission: mission, astronauts: self.astronauts)) {
                    ...
                    VStack(alignment: .leading) {
                        ...
                        Text(self.showingDates ? mission.formatterLaunchDate : self.crewNames(mission: mission.id))
                            .accessibility(label: Text(self.showingDates ?
                                "Launch Date \(mission.formatterLaunchDate)" :
                                "Crew: \(self.crewNames(mission: mission.id))"))
                    }
                }
            }
            ...
            .navigationBarItems(trailing:
                HStack {
                    ...
                    .accessibility(label: Text(showingDates ?
                        "Showing dates click to show crew names" :
                        "Showing crew names click to show dates"))
            })
        }
    }
